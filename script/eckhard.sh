...
perl $GTHOME/gt/script/sort-cg-cohort.pl $GTBIG/gt/sme/corp/correct/divgullkorpus.N.corr.txt | uniq >> $GTHOME/gt/sme/dev/ECKH-cleantestkorpus.dis.corrINTERMEDIATE
