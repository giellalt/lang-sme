...
cat $GTBIG/gt/sme/corp/testkorpus.txt $GTBIG/gt/sme/corp/divgullkorpus.txt | preprocess --abbr=$GTHOME/gt/sme/bin/abbr.txt | $LOOKUP $GTHOME/gt/sme/bin/sme.fst | lookup2cg | vislcg3 -g $GTHOME/gt/sme/src/sme-dis.rle | vislcg3 -g $GTHOME/gtcore/langs-templates/smi/src/syntax/functions.cg3 > $GTHOME/gt/sme/dev/syntestdis


# Fjerner semantiske tagger, # osv:

cat $GTHOME/gt/sme/dev/syntestdis | perl -pe 's/(Allegro|v1|v2|v3|v4|v5|v6|v7|v8|<vdic>) //g' | tr -d "#" > $GTHOME/gt/sme/dev/syncleantestdis
...
cat $GTBIG/gt/sme/corp/correct/testkorpus.dis.corr.txt $GTBIG/gt/sme/corp/correct/divgullkorpus.dis.corr.txt | perl -pe 's/(Allegro|v1|v2|v3|v4|v5|v6|v7|v8|<vdic>) //g' | tr -d "#" > $GTHOME/gt/sme/dev/syncleangullkorpus.dis.corr.txt
