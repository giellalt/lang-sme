...
This directory contains source files for the Northern Sami language
...
-   <https://giellalt.uit.no/lang/sme/j-sme.html> (analyser)
...
The Northern Sami language sources can be acquired using [giella SVN
