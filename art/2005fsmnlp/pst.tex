...
\section{Pedagogical programs}\label{ped}

Twol in practice.


\section{Spell checker}\label{spell}


ikkje-pøermissiv automat - korleis får vi det til?
...
\section{Terminological database}\label{term}
