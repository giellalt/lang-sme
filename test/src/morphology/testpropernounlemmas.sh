...
# Hent ut lemmaer fra den genererte fila smi-sme-propernouns.lexc, bortsett fra utkommmenterte (^\!),  dem som krever +Attr tag og hardkoding for spesielle former (Attr|FirstTag|-atr|),  LexSub (som blir filtrert bort fra normgenerator). Lemmaene lagres som props
